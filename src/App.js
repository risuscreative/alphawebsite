...
function App() {
  ...
  if (isLoading == true) return (<>
    <div style={{height: "100vh", width: "100%", backgroundColor: "BLACK", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "2rem", position: "relative"}}>
      <div style={{height: "10rem", width: "10rem", opacity: "0.4", backgroundColor: "RED", filter: "blur(64px)", position: "absolute", top: "0", left: "0"}}></div>
      <div style={{height: "10rem", width: "10rem", opacity: "0.4", backgroundColor: "RED", filter: "blur(64px)", position: "absolute", bottom: "0", right: "0"}}></div>
      <img style={{width: "5rem", height: "5rem"}} src="https://cdn.discordapp.com/attachments/977578170389778432/1122824965813710901/Baslksz-2.png"/>
