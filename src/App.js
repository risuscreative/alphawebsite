...
function App() {
  ...
  if (isLoading == true) return (<>
    <div style={{height: "100vh", width: "100%", backgroundColor: "BLACK", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "2rem", position: "relative"}}>
      <div style={{height: "15rem", width: "15rem", opacity: "0.3", backgroundColor: "RED", filter: "blur(64px)", position: "absolute", top: "0", left: "0"}}></div>
      <div style={{height: "15rem", width: "15rem", opacity: "0.3", backgroundColor: "RED", filter: "blur(64px)", position: "absolute", bottom: "0", right: "0"}}></div>
